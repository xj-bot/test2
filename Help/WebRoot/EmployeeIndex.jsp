        ...
        <div class="responsive-header visible-xs visible-sm">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="top-section">
                            <div class="profile-image">
                                <img src= '<s:property value="#session.employee.employeeIMG"/>' alt="Volton"/><%//！！用户头像的存放路径还得修改！！%>
                            </div>
                            <div class="profile-content">
                                <h3 class="profile-title"><s:property value="#session.employee.employeeUserName" /></h3>
                                ...
                                <p class="profile-description"><s:property value="#session.employee.employeeSignature" /></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="main-navigation responsive-menu">
                    <ul class="navigation">
                   		 <li><a href="#about" onclick="showDiv('about')"><i class="fa fa-th-large"></i>招募信息</a></li>
        ...
        <div class="main-content">
            <div class="fluid-container">
                <div class="content-wrapper">
                    ...
                    <!-- 招募信息 -->
                    <div id="about" >
                    	<iframe id="findMission" name="findMission" src="OrderByDefault" frameborder="0" scrolling="no" onload="reinitIframe('findMission')" width=100% height="600px"></iframe>
                    </div>
                    
                    <!-- 历史订单 -->
                    <div id="historyMission" style="display:none">
                    	<iframe id="history" name="history" src="findWeek" frameborder="0" scrolling="no" width=100% height="1100px"></iframe>
                    </div>
                    <!-- 个人信息 -->
                    ...
                    <div class="row">
                        <form action="EmployeeUpdated" method="post" class="contact-form"><!-- 查看、更新个人信息 -->
                            <s:hidden name="employee.employeeID" value="%{#session.employee.employeeID}"/><!-- 账号 -->
                            <s:hidden name="employee.employeePassword" value="%{#session.employee.employeePassword}"/><!-- 密码 -->
                            <s:hidden name="employee.employeeSex" value="%{#session.employee.employeeSex}"/><!-- 性别 -->
                            <s:hidden name="employee.employeeGrade" value="%{#session.employee.employeeGrade}"/><!-- 等级 -->
                            <s:hidden name="employee.employeeState" value="%{#session.employee.employeeState}"/><!-- 审核状态 -->
                            <s:hidden name="employee.employeeIMG" value="%{#session.employee.employeeIMG}"/><!-- 头像 -->
                            <s:property value="#request.updateTip"/>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>昵称：</p>
                            	<input type="text" name="employee.employeeUserName" value="<s:property value="#session.employee.employeeUserName"/>"/>
                            </fieldset>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>真实姓名：</p>
                            	<input type="text" name="employee.employeeName" value="<s:property value="#session.employee.employeeName"/>" readonly/>
                            </fieldset>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>身份证号：</p>
                                <input type="text" name="employee.employeeIDNum" value="<s:property value="#session.employee.employeeIDNum"/>" readonly/>
                            </fieldset>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>性别：</p>
                            ...
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>年龄：</p>
                                <input type="text" name="employee.employeeAge" value="<s:property value="#session.employee.employeeAge"/>" readonly/>
                            </fieldset>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>联系方式：</p>
                                <input type="text" name="employee.employeePhone" value="<s:property value="#session.employee.employeePhone"/>"/>
                            </fieldset>
                            <fieldset class="col-md-4 col-sm-6">
                            	<p>住址：</p>
                                <input type="text" name="employee.employeeAddress" value="<s:property value="#session.employee.employeeAddress"/>"/>
                            </fieldset>
                            <fieldset class="col-md-12 col-sm-12">
                            	<p>个性签名：</p>
                                <textarea name="employee.employeeSignature" cols="30" rows="6" ><s:property value="#session.employee.employeeSignature"/></textarea>
                            </fieldset>
                            <fieldset class="col-md-12 col-sm-12">
